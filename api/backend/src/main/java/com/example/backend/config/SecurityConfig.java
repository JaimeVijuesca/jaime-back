...
public class SecurityConfig {
        ...
        private final OAuth2UserService<OidcUserRequest, OidcUser> loginApplicationService;

        public SecurityConfig(OAuth2UserService<OidcUserRequest, OidcUser> loginApplicationService) {
        ...
        SecurityFilterChain filterChain(HttpSecurity http, ClientRegistrationRepository clientRegistrationRepository)
                ...
                http
                                ...
                                .authorizeHttpRequests(auth -> auth
                                                .requestMatchers("/", "/health", "/api/**", "/login/**", "/oauth2/**",
                                                                "/css/**", "/js/**",
                                                                "/error", "/test", "/add/formCV", "/cv")
                                                .permitAll()
                                ...
                                .oauth2Login(oauth2 -> oauth2
                                                ...
                                                .userInfoEndpoint(userInfo -> userInfo
                                                                .oidcUserService(loginApplicationService))
